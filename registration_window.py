...
class RegistrationWindow(QtGui.QMainWindow):
        ...
        if (check_value == 1):
            ...
            while True:
                ...
                for (x,y,w,h) in face:
                    ...
                    cv2.imwrite(str(r'D:\\btech project\\Automatic Attendance System\\registration_images\\Year' +
            ...
            self.pic.setPixmap(QtGui.QPixmap(str(r'D:\\btech project\\Automatic Attendance System\\registration_images\\Year' +
    ...
    def check(self):
        ...
        try:
            img = cv2.imread(r'D:\\btech project\\Automatic Attendance System\\registration_images\\Year' +
